...
function cards() {
  var Menu = /*#__PURE__*/function () {
    function Menu(src, altimg, title, descr, price, selector) {
  ...
  function getResource() {
    Object(_services_services__WEBPACK_IMPORTED_MODULE_3__["getFromServer"])('http://localhost:3000/menu').then(function (data) {
...
function forms(formSelector) {
  ...
  function thanksForm(message) {
    ...
    Object(_modal__WEBPACK_IMPORTED_MODULE_7__["showModal"])('.modal');
    modalContent.classList.add('hide');
    var modalThanks = document.createElement('div');
...
function showModal(modalCalass) {
  var modal = document.querySelector(modalCalass);
...
function slider(_ref) {
  var slidesSelector = _ref.slidesSelector,
      ...
      field = _ref.field,
      nextClass = _ref.nextClass,
      prevClass = _ref.prevClass,
      totalSlide = _ref.totalSlide,
      currentSlides = _ref.currentSlides,
      dots = _ref.dots;
  ...
  function dotsColor(dots) {
    dots.forEach(function (dot) {
      return dot.style.backgroundColor = '#fff';
    });
...
function tabs(tabCantainerSelector, tabsSelector, itemsSelector, activeSelector) {
  var tabContainer = document.querySelector(tabCantainerSelector),
...
var getFromServer = /*#__PURE__*/function () {
  ...
  return function getFromServer(_x3) {
